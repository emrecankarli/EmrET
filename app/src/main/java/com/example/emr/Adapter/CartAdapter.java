...
import com.example.emr.Helper.ChangeNumberItemsListener;
...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.Viewholder> {
    ...
    public void onBindViewHolder(@NonNull CartAdapter.Viewholder holder, int position) {
        ...
        holder.totalEachItem.setText(listItemSelected.get(position).getNumberInCart() + " Adet "
                + (listItemSelected.get(position).getNumberInCart() * listItemSelected.get(position).getPrice()) + " TL");
